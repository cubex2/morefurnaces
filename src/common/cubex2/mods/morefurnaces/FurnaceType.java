...
public enum FurnaceType {
	...
	public static void generateRecipes(BlockMoreFurnaces blockResult) {
		ItemStack previous = new ItemStack(Block.stoneOvenIdle);
		for (FurnaceType typ : values()) {
			ShapedOreRecipe recipe = new ShapedOreRecipe(new ItemStack(blockResult, 1, typ.ordinal()), typ.recipe, 'I', Item.ingotIron, 'G', Item.ingotGold, 'D', Item.diamond, 'O', Block.obsidian, 'N', Block.netherrack, 'F', Block.stoneOvenIdle, '1', new ItemStack(MoreFurnaces.blockFurnaces, 0), 'P', previous);
