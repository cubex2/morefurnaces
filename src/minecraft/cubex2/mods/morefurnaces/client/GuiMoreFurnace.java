...
public class GuiMoreFurnace extends GuiContainer {
	public enum GUI {
		IRON(176, 166, 56, 36, 176, 12, new int[] { 79 }, new int[] { 34 }, 176, 14, "/cubex2/mods/morefurnaces/client/textures/ironfurnace.png", FurnaceType.IRON), GOLD(216, 166, 63, 36, 216, 12, new int[] { 79 }, new int[] { 34 }, 216, 14, "/cubex2/mods/morefurnaces/client/textures/goldfurnace.png", FurnaceType.GOLD), DIAMOND(216, 202, 63, 54, 216, 12, new int[] { 79 }, new int[] { 52 }, 216, 14, "/cubex2/mods/morefurnaces/client/textures/diamondfurnace.png", FurnaceType.DIAMOND), OBSIDIAN(176, 196, 56, 66, 176, 12, new int[] {
				79,
				79 }, new int[] { 17, 43 }, 176, 14, "/cubex2/mods/morefurnaces/client/textures/obsidianfurnace.png", FurnaceType.OBSIDIAN), NETHERRACK(176, 166, 56, 36, 176, 12, new int[] { 79 }, new int[] { 34 }, 176, 14, "/cubex2/mods/morefurnaces/client/textures/netherrackfurnace.png", FurnaceType.NETHERRACK);
		private int xSize;
		private int ySize;
