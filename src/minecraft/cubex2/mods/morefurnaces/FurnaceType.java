...
public enum FurnaceType
{
	...
	OBSIDIAN(2, 2, 2, 2, 150, new int[] { 56, 56 }, new int[] { 17, 43 }, new int[] {
			38,
			38 }, new int[] { 17, 43 }, 56, 83, 38, 83, new int[] { 116, 116 }, new int[] {
			18,
			44 }, new int[] { 138, 138 }, new int[] { 22, 48 }, 8, 114, "Obsidian Furnace", TileEntityObsidianFurnace.class, "OOO", "O1O", "OOO"),
	...
	public static void generateRecipes(BlockMoreFurnaces blockResult)
	{
		...
		{
			ShapedOreRecipe recipe = new ShapedOreRecipe(new ItemStack(blockResult, 1, typ.ordinal()), typ.recipe, 'I', Item.ingotIron, 'G', Item.ingotGold, 'D', Item.diamond, 'O', Block.obsidian, 'N', Block.netherrack, 'F', Block.furnaceIdle, '1', new ItemStack(MoreFurnaces.blockFurnaces, 0), 'P', previous);
